...
namespace SampleBinaryClassification.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Dev\git\mldotnet-real-time-data-streaming-workshop\workspace\FraudPredictionTrainer\data.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.IsFraud} | Predicted value: {predictionResult.Prediction}");
